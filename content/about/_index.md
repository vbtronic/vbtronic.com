...
**Websites** — front end and back end, built with AI, from scratch rather than from a template. This is the one thing I do regularly and have finished for paying customers.

## What I'm Learning

Everything below this line I am still learning. I have not done it for real yet, so I am not going to sell it as experience:

- **Applications** — internal systems, customer portals, e-shops
- **AI tools** — putting a model where it earns its place, and leaving it out where it doesn't
- **Automation** — the repetitive work that eats hours every week
- **Source research and checking** — finding where a claim came from, indexing it, and checking each source

If you need one of those, ask me anyway — I will tell you straight whether I am the right person for it, and if I am not, I will say so.

## Where to See It

- [Portfolio](/portfolio/) — client work built and finished, starting with [jakubkocman.cz](https://jakubkocman.cz)
...
- [Projects](/products/) — the full list, including the open-source work
...
- **2026** — Shipped [jakubkocman.cz](https://jakubkocman.cz), the first client site in the [Portfolio](/portfolio/)
- **2026** — Founded Bruncsoft and launched bruncsoft.com
- **2026** — Built vbtronic.com using Hugo, Amp, and Claude Code
- **2025** — Started learning programming and building with AI tools
